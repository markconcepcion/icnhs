						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Create teacher/staff account</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">		
					<?php echo form_open_multipart('/guidance/User/addUser'); ?>
						...
						<div class="row">
							...
							<div class="col-md-3 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control date-picker" name="birthdate" placeholder="Select Birthdate" required>
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-md-3 col-sm-12">
								<div class="form-group">
									...
									<input type="text" name="municity" class="form-control" required>
								</div>
							</div>
							<div class="col-md-3 col-sm-12">
								<div class="form-group">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<select class="custom-select2 form-control" name="user_level" style="width: 100%; height: 38px;" required>
