					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url("guidance/add_classschedule");?>">Back</a></li>
									<li class="breadcrumb-item active" aria-current="page">Class Schedule by Section</li>
								</ol>
							</nav>
						</div>
					</div>
