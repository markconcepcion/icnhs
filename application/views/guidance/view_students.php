					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								...
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url("guidance/selectyrtoview");?>">Back</a></li>
					...
					<table class="table table-bordered">
							...
							<tbody>
								<tr>
									...
									<td>
										<div class="row">
											<a class="btn btn-info" href="<?php echo base_url("guidance/view_studentprofile2");?>" role="button" style="margin-left: 15px; ">
														View Profile
													</a>
											<a class="btn btn-success" href="<?php echo base_url("guidance/view_studentclass");?>" role="button" style="color: white; margin-left: 15px;">
														View Schedule
													</a>
										</div>
									</td>
