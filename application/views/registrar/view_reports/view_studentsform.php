					...
					<table class="table-color" style="margin-bottom: 20px;">
						...
						<tbody>
							<tr>
								...
								<td>Enrique Gil</td>
								<td>
									<a class="btn btn-success" href="<?php echo base_url("registrar/view_reports/grade11_form138");?>" role="button" style="margin-right: 5px; background:">
											View Form 138</a>
									<a class="btn btn-primary" href="<?php echo base_url("registrar/view_reports/grade11_form137");?>" role="button" style="margin-right: 5px; background:">
											View Form 137</a>
								</td>
							</tr>
						</tbody>
