					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url("registrar/compose/view_mail");?>">Back</a></li>
									<li class="breadcrumb-item active" aria-current="page">Mail</li>
								</ol>
							</nav>
							<a href="<?php echo base_url("registrar/compose/compose_mail");?>" class="btn" style="background: #00b38f; margin-bottom: 10px; margin-top: -5px; color: white; font-size: 15px;"><i class="icon-copy ion-reply"></i>Reply</a>
						</div>
					</div>
				</div>
