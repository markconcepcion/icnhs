				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-12 col-sm-12">
							...
							<a class="btn" href="<?php echo base_url("teacher/composemail/compose_mail");?>" role="button" style="color: white; background: #00b38f; margin-bottom: 10px; margin-top: -5px;">Compose Mail</a>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 mb-30">
						<div class="pd-20 bg-white border-radius-4 box-shadow">
							...
							<ul>
								<li>
									<a href="<?php echo base_url("teacher/composemail/mail");?>">
