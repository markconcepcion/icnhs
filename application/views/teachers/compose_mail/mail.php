				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-12 col-sm-12">
							...
							<a href="<?php echo base_url("teacher/composemail/compose_mail");?>" class="btn" style="background: #00b38f; margin-bottom: 10px; margin-top: -5px; color: white; font-size: 15px;"><i class="icon-copy ion-reply"></i>Reply</a>
						</div>
					</div>
				</div>
