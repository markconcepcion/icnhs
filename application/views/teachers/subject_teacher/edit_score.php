									...
									<table class="table-color">
										...
										<tbody>
											<tr>
												...
												<td><input class="field" type="" value="10/10" name=""></td>
												<td><input class="field" type="" value="10/10" name=""></td>
												<td><input class="field" type="" value="10/10" name=""></td>
												<td>100</td>
												<td><input class="field" type="" value="10/10" name=""></td>
												...
												<td>100</td>
												<td>
													<button class="btn-secondary bton">Cancel</button>
                                                    <button class="btn-primary bton">Save</button>
												</td>
											</tr>
									...
									<table class="table-color">
										...
										<tbody>
											<tr style="height: 40px;">
												...
												<td ><input class="field" type="" style="text-align: center;" value="100/100" name=""></td>
