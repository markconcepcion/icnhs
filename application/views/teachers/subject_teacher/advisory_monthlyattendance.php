    ...
    <div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
      <div class="min-height-200px">
        <div class="page-header">
          ...
          <p> Legend: <strong class="text-primary">P</strong> = Present <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong class="text-danger">A</strong> = Absent
              <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong class="text-danger">E</strong> = Excused </p>
              ...
              <table id="datatable" class= "table table-striped table-bordered">
                                ...
                                <thead>
                                            <tr>
                                                <th><b>ID</b></th>
                                                <th><b>Name</b></th>
                                                <th colspan="3" class="text-center table-bordered"><b>Month of May</b></th> 
                                        ...
                                        <thead>
                                            <tr>
                                                <th> </th>
                                                <th> </th>
                                                <th colspan="3" class="text-center table-bordered"><b>DAY</b></th>
                                                
                                                <th><b class="text-success"><big>Present Days 3</big></b></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><b class="text-primary"><big>P</big></b></td>
                                                <td><b class="text-primary"><big>P</big></b></td>
                                                <td><b class="text-danger"><big>A</big></b></td>
                                                <td class="text-center"> <b class="text-primary"><small><small><small>PRESENTS</small></small></small> <big>2</big>  </b> / <b class="text-danger"><small><small><small>Absents</small></small></small> <big>1</big></b></td>
