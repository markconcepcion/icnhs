						...
						<table class="table table-bordered" style="margin-bottom: 20px;">
							...
							<tbody>
								<tr>
									<td>11908432</td>
									<td>Amanda Clarin</td>
									<td>Manticao, Misamis Oriental</td>
									<td>0957305342</td>
									<td>
										<a class="btn btn-info" href="<?php echo base_url("teacher/subjectteacher/view_gradeBystudent");?>" role="button" style="margin-right: 5px; ">
											View Final Grade</a>
