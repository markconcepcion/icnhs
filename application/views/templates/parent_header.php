			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a class="dropdown-item" href="<?php echo base_url("parent/parent_account/view_account");?>"><i class="fa fa-user-md" aria-hidden="true"></i> View Profile</a> 
				...
				<ul id="accordion-menu">
					...
					<li>
						<a href="<?php echo base_url("student/student_class/my_class");?>" class="dropdown-toggle no-arrow">
							<span class="fa fa-folder"></span><span class="mtext">My Class</span></span>
						</a>
					</li>
					<li>
						<a href="<?php echo base_url("student/student_reportcard/view_reportcard");?>" class="dropdown-toggle no-arrow">
							<span class="fa fa-list-alt"></span><span class="mtext">View Grade</span></span>
						</a>
					</li>
					
					
					<li>
						<a href="<?php echo base_url("student/mails/view_mails");?>" class="dropdown-toggle no-arrow">
							<span class="fa fa-envelope"></span><span class="mtext">View Mails</span></span>
						</a>
					</li>
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-folder"></span><span class="mtext">Advisory</span>
						</a>
						<ul class="submenu">
							<li><a href="<?php echo base_url("teacher/subjectteacher/view_mystudentgrade");?>">View Grades(by Subject)</a></li>
							<li><a href="<?php echo base_url("teacher/adviser/student_list");?>">View Grade(by Student)</a></li>
						</ul>
					</li>
					...
					<?php elseif($this->session->userdata('level')==='parent'):?>
					<li>
					...
					<li>
						<a href="<?php echo base_url("parent/my_class/student_name");?>" class="dropdown-toggle no-arrow">
							<span class="fa fa-folder"></span><span class="mtext">My Class</span></span>
						</a>
					</li>
					<li>
