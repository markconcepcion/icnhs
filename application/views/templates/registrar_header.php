		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-file"></span><span class="mtext">Reports</span>
						</a>
						<ul class="submenu">
							<li><a href="<?php echo base_url("registrar/view_reports/select_yeargrade11");?>">Grade 11</a></li>
							<li><a href="<?php echo base_url("registrar/view_reports/grade12_selectyr");?>">Grade 12</a></li>
						</ul>
					</li>
					<li>
						<a href="<?php echo base_url("registrar/teachers_record/view_teachers");?>" class="dropdown-toggle no-arrow">
							<span class="fa fa-folder"></span><span class="mtext">Pendings</span>
						</a>
					</li>
					<li>
						<a href="<?php echo base_url("registrar/compose/set_schedule");?>" class="dropdown-toggle no-arrow">
							<span class="fa fa-calendar"></span><span class="mtext">Set Schedule</span>
						</a>
					</li>
